...
X_train_imdb=np.load("Semana 5 - Implementación de algoritmos de aprendizaje/datos-trabajo-aa/datos/imdb_sentiment/vect_train_text.npy")
X_test_imdb=np.load("Semana 5 - Implementación de algoritmos de aprendizaje/datos-trabajo-aa/datos/imdb_sentiment/vect_test_text.npy")
y_train_imdb=np.load("Semana 5 - Implementación de algoritmos de aprendizaje/datos-trabajo-aa/datos/imdb_sentiment/y_train_text.npy")
y_test_imdb=np.load("Semana 5 - Implementación de algoritmos de aprendizaje/datos-trabajo-aa/datos/imdb_sentiment/y_test_text.npy")
